 ...
 * mmm.cache.set('mykey', data);
 *
 * // Get an item from the cache
 * var value = mmm.cache.get('mykey');
 *
 * // Remove an item from the cache
 * mmm.cache.remove('mykey');
 */
 ...
 * mmm.cache.set('mykey', 'mystring');
 *
 * // Add an object to persist in the file cache
 * mmm.cache.set('mykey', data, {persist: true});
 *
 * // Add an object to the cache for five seconds
 * mmm.cache.set('mykey', data, {ttl: 5});
 */
