...
// Set our maxListeners to something more reasonable for mmm
 ...
 * mmm.events.on('post-instantiate-app', 1, function(app) {
 *   console.log(app);
 * });
 *
 ...
 *   mmm.log.info('App %s started', app.name);
 * });
 */
 ...
 * return mmm.events.emit('wolf359', config);
 *
